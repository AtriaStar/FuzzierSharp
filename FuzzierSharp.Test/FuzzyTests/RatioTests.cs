...
namespace FuzzierSharp.Test.FuzzyTests
{
    [TestFixture]
    public class RatioTests
    {
        ...
        public void Test_Case_Insensitive()
        {
            ...
            Assert.AreEqual(Fuzz.Ratio(_s1, _s2, StandardPreprocessors.Full), 100);
        }
        ...
        {
            Assert.AreEqual(Fuzz.PartialTokenSortRatio(_s1, _s1A, StandardPreprocessors.Full), 100);
            Assert.AreEqual(Fuzz.PartialTokenSortRatio(_s4, _s5, StandardPreprocessors.Full), 100);
            Assert.AreEqual(Fuzz.PartialTokenSortRatio(_s8, _s8A), 100);
            Assert.AreEqual(Fuzz.PartialTokenSortRatio(_s9, _s9A, StandardPreprocessors.Full), 100);
        ...
        {
            Assert.AreEqual(Fuzz.TokenSetRatio(_s4, _s5, StandardPreprocessors.Full), 100);
            Assert.AreEqual(Fuzz.TokenSetRatio(_s8, _s8A), 100);
            Assert.AreEqual(Fuzz.TokenSetRatio(_s9, _s9A, StandardPreprocessors.Full), 100);
        ...
        {
            Assert.AreEqual(Fuzz.TokenAbbreviationRatio("bl 420", "Baseline section 420", StandardPreprocessors.Full), 40);
            Assert.AreEqual(Fuzz.PartialTokenAbbreviationRatio("bl 420", "Baseline section 420", StandardPreprocessors.Full), 50);
        }
        ...
        {
            Assert.AreEqual(Fuzz.WeightedRatio(_s1, _s2, StandardPreprocessors.Full), 100);
        }
        ...
        {
            // https://github.com/JakeBayer/FuzzierSharp/issues/8
